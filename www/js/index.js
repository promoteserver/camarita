...
var app = {  
    ...
    ft.upload(fichero, encodeURI("http://promoteserver.com/test_canonbury/index.php"), app.win, app.fail, options);
    ...
    takePhoto: function(){  
        navigator.camera.getPicture(app.onPhotoDataSuccess, app.onFail, { quality: 20,   
            allowEdit: true, destinationType: navigator.camera.DestinationType.FILE_URL ,sourceType: Camera.PictureSourceType.CAMERA});  
    },  
